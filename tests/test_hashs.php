...
echo "MD2 SIGNED {$signed} " . (BaseSigner::validateUrl($signed) ? "IS VALID" : "ISN'T VALID ANYMORE") . "\n";
sleep(2);
echo "MD2 SIGNED {$signed} " . (BaseSigner::validateUrl($signed) ? "IS VALID" : "ISN'T VALID ANYMORE") . "\n\n";
// Trying MD4
$signed = BaseSigner::with('md4')->signUrl($url, time() + 1);
echo "MD4 SIGNED {$signed}\n";
echo "MD4 SIGNED {$signed} " . (BaseSigner::validateUrl($signed) ? "IS VALID" : "ISN'T VALID ANYMORE") . "\n";
sleep(2);
echo "MD4 SIGNED {$signed} " . (BaseSigner::validateUrl($signed) ? "IS VALID" : "ISN'T VALID ANYMORE") . "\n\n";
...
echo "MD5 SIGNED {$signed} " . (BaseSigner::validateUrl($signed) ? "IS VALID" : "ISN'T VALID ANYMORE") . "\n";
sleep(2);
echo "MD5 SIGNED {$signed} " . (BaseSigner::validateUrl($signed) ? "IS VALID" : "ISN'T VALID ANYMORE") . "\n\n";
...
echo "SHA1 SIGNED {$signed} " . (BaseSigner::validateUrl($signed) ? "IS VALID" : "ISN'T VALID ANYMORE") . "\n";
sleep(2);
echo "SHA1 SIGNED {$signed} " . (BaseSigner::validateUrl($signed) ? "IS VALID" : "ISN'T VALID ANYMORE") . "\n\n";
...
echo "SHA256 SIGNED {$signed} " . (BaseSigner::validateUrl($signed) ? "IS VALID" : "ISN'T VALID ANYMORE") . "\n";
sleep(2);
echo "SHA256 SIGNED {$signed} " . (BaseSigner::validateUrl($signed) ? "IS VALID" : "ISN'T VALID ANYMORE") . "\n\n";
...
echo "SHA384 SIGNED {$signed} " . (BaseSigner::validateUrl($signed) ? "IS VALID" : "ISN'T VALID ANYMORE") . "\n";
sleep(2);
echo "SHA384 SIGNED {$signed} " . (BaseSigner::validateUrl($signed) ? "IS VALID" : "ISN'T VALID ANYMORE") . "\n\n";
...
echo "SHA512 SIGNED {$signed} " . (BaseSigner::validateUrl($signed) ? "IS VALID" : "ISN'T VALID ANYMORE") . "\n";
sleep(2);
echo "SHA512 SIGNED {$signed} " . (BaseSigner::validateUrl($signed) ? "IS VALID" : "ISN'T VALID ANYMORE") . "\n\n";
...
echo "HS256 SIGNED {$signed} " . (BaseSigner::validateUrl($signed) ? "IS VALID" : "ISN'T VALID ANYMORE") . "\n";
sleep(2);
echo "HS256 SIGNED {$signed} " . (BaseSigner::validateUrl($signed) ? "IS VALID" : "ISN'T VALID ANYMORE") . "\n\n";
...
echo "HS384 SIGNED {$signed} " . (BaseSigner::validateUrl($signed) ? "IS VALID" : "ISN'T VALID ANYMORE") . "\n";
sleep(2);
echo "HS384 SIGNED {$signed} " . (BaseSigner::validateUrl($signed) ? "IS VALID" : "ISN'T VALID ANYMORE") . "\n\n";
...
echo "HS512 SIGNED {$signed} " . (BaseSigner::validateUrl($signed) ? "IS VALID" : "ISN'T VALID ANYMORE") . "\n";
sleep(2);
echo "HS512 SIGNED {$signed} " . (BaseSigner::validateUrl($signed) ? "IS VALID" : "ISN'T VALID ANYMORE") . "\n\n";
