...
// Trying MD2
$signed = BaseSigner::with('md2')->signUrl($url, time() + 1, $pass);
...
// Trying MD4
$signed = BaseSigner::with('md4')->signUrl($url, time() + 1, $pass);
...
// Trying MD5
$signed = BaseSigner::with('md5')->signUrl($url, time() + 1, $pass);
...
// Trying SHA1
$signed = BaseSigner::with('sha1')->signUrl($url, time() + 1, $pass);
...
// Trying SHA256
$signed = BaseSigner::with('sha256')->signUrl($url, time() + 1, $pass);
...
// Trying SHA384
$signed = BaseSigner::with('sha384')->signUrl($url, time() + 1, $pass);
...
// Trying SHA512
$signed = BaseSigner::with('sha512')->signUrl($url, time() + 1, $pass);
...
// Trying HS256
$signed = BaseSigner::with('hs256')->signUrl($url, time() + 1, $pass);
...
// Trying HS384
$signed = BaseSigner::with('hs384')->signUrl($url, time() + 1, $pass);
...
// Trying HS512
$signed = BaseSigner::with('hs512')->signUrl($url, time() + 1, $pass);
